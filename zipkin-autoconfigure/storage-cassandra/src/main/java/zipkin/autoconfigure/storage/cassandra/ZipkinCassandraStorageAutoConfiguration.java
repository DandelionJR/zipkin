...
class ZipkinCassandraStorageAutoConfiguration {
  ...
  V2StorageComponent storage(ZipkinCassandraStorageProperties properties,
  ...
  @Bean zipkin2.storage.cassandra.CassandraStorage v2Storage(V2StorageComponent component) {
    return (zipkin2.storage.cassandra.CassandraStorage) component.delegate();
  }
}
